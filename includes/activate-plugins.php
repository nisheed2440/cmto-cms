...
add_action( 'tgmpa_register', 'cmto_theme_register_required_plugins' );

function cmto_theme_register_required_plugins() {
	/*
	...
	$plugins = array(
		...
		array(
			...
			'source'   => get_stylesheet_directory() . '/plugins/custom-post-type-ui.1.5.8.zip',
			'required' => true,
        ),
        array(
			'name'     => 'Advanced Custom Fields',
			'slug'     => 'advanced-custom-fields',
			'source'   => get_stylesheet_directory() . '/plugins/advanced-custom-fields.4.4.12.zip',
			'required' => true,
		)
	);
